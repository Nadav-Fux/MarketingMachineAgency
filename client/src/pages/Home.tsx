  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-slate-50 overflow-hidden">
      ...
      <section className="relative pt-32 pb-20 px-4 overflow-hidden">
        ...
        <div className="absolute top-20 right-0 w-96 h-96 bg-orange-500/10 rounded-full blur-3xl -z-10"></div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="lg:col-span-1 order-2 lg:order-1">
              <div className="space-y-6">
                ...
                <div className="pt-8 border-t border-slate-800">
                  <p className="text-sm text-slate-500 mb-2">הגישה שלי:</p>
            ...
            {/* Right side - Visual element (asymmetrical) */}
            <div className="lg:col-span-1 order-1 lg:order-2 relative">
              <div className="relative w-full h-96 flex items-center justify-center">
                {/* Animated SVG-like machine visualization */}
                <svg
                  viewBox="0 0 400 400"
                ...
                {/* Glow effect */}
                <div className="absolute inset-0 bg-gradient-to-r from-orange-500/20 to-red-600/20 rounded-full blur-2xl -z-10"></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="expertise" className="py-20 px-4 bg-slate-900/50 border-y border-slate-800">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4">המומחיות שמניעה את המכונה</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-1 group">
              <div className="relative p-6 bg-gradient-to-br from-slate-800 to-slate-900 border border-slate-700 rounded-lg hover:border-orange-500/50 transition h-full">
                ...
                <TrendingUp className="w-10 h-10 text-orange-500 mb-4 relative z-10" />
                <h3 className="text-lg font-bold mb-2 relative z-10">המוח האנליטי</h3>
            ...
            <div className="lg:col-span-1 group md:translate-y-8">
              <div className="relative p-6 bg-gradient-to-br from-slate-800 to-slate-900 border border-slate-700 rounded-lg hover:border-red-500/50 transition h-full">
                ...
                <Zap className="w-10 h-10 text-red-500 mb-4 relative z-10" />
                <h3 className="text-lg font-bold mb-2 relative z-10">הלב העסקי</h3>
                <p className="text-slate-400 text-sm relative z-10">
            ...
            <div className="lg:col-span-1 group">
              <div className="relative p-6 bg-gradient-to-br from-slate-800 to-slate-900 border border-slate-700 rounded-lg hover:border-orange-500/50 transition h-full">
                <div className="absolute top-0 right-0 w-20 h-20 bg-orange-500/10 rounded-full blur-xl group-hover:bg-orange-500/20 transition"></div>
                <Palette className="w-10 h-10 text-orange-500 mb-4 relative z-10" />
                <h3 className="text-lg font-bold mb-2 relative z-10">היד הקריאייטיבית</h3>
                <p className="text-slate-400 text-sm relative z-10">
            ...
            <div className="lg:col-span-1 group md:translate-y-8">
              <div className="relative p-6 bg-gradient-to-br from-slate-800 to-slate-900 border border-slate-700 rounded-lg hover:border-red-500/50 transition h-full">
                <div className="absolute top-0 right-0 w-20 h-20 bg-red-500/10 rounded-full blur-xl group-hover:bg-red-500/20 transition"></div>
                <Cog className="w-10 h-10 text-red-500 mb-4 relative z-10" />
                <h3 className="text-lg font-bold mb-2 relative z-10">המנגנון התפעולי</h3>
                <p className="text-slate-400 text-sm relative z-10">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="space-y-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                <h3 className="text-3xl font-bold mb-4">ארכיטקטורה אסטרטגית</h3>
              ...
              <div className="h-64 bg-gradient-to-br from-orange-500/20 to-red-600/20 rounded-lg border border-slate-700 flex items-center justify-center">
                <div className="text-center">
                  <TrendingUp className="w-16 h-16 text-orange-500 mx-auto mb-4" />
                  <p className="text-slate-400">תוכנית עסקית מדויקת</p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div className="h-64 bg-gradient-to-br from-red-600/20 to-orange-500/20 rounded-lg border border-slate-700 flex items-center justify-center order-2 lg:order-1">
                <div className="text-center">
                  <Zap className="w-16 h-16 text-red-500 mx-auto mb-4" />
                  <p className="text-slate-400">קמפיינים רב-ערוציים</p>
                </div>
              </div>
              <div className="order-1 lg:order-2">
                <h3 className="text-3xl font-bold mb-4">ניהול קמפיינים</h3>
                <p className="text-slate-300 text-lg mb-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                <h3 className="text-3xl font-bold mb-4">קריאייטיב ותוכן</h3>
                <p className="text-slate-300 text-lg mb-6">
              ...
              <div className="h-64 bg-gradient-to-br from-orange-500/20 to-red-600/20 rounded-lg border border-slate-700 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-slate-400">קריאייטיב שוברי רעש</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* CTA Section */}
      <section id="contact" className="py-20 px-4 bg-gradient-to-r from-orange-500/10 to-red-600/10 border-y border-slate-800">
      ...
      <footer className="bg-slate-950 border-t border-slate-800 py-12 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            <div>
              <h4 className="font-bold mb-4">{COMPANY_NAME}</h4>
              <p className="text-slate-400 text-sm">
                סוכנות שיווק דיגיטלית המשלבת אנליטיקה כלכלית עם קריאייטיב מקורי.
              </p>
            </div>
            <div>
              <h4 className="font-bold mb-4">ניווט</h4>
